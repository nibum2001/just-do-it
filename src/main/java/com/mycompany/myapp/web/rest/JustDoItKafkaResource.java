...
@RestController
@RequestMapping("/api/just-do-it-kafka")
public class JustDoItKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JustDoItKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JustDoItKafkaResource(KafkaProperties kafkaProperties) {
