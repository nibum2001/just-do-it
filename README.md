...
To build the final jar and optimize the JustDoIt application for production, run:
...
[doing api-first development]: https://www.jhipster.tech/documentation-archive/v7.5.0/doing-api-first-development/
